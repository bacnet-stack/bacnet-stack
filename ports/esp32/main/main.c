...
#include "bacnet/basic/tsm/tsm.h"
// conflict filename address.h with another file in default include paths / Are there really problems? include the default path:
...
// uint8_t Handler_Transmit_Buffer[MAX_PDU] = { 0 }; /* already defined in tsm.c */
