...
* Secured ubasic interpreter tokenizer_string() off-by-one buffer overflow
  when processing string literals longer than the buffer limit.
  ...
  Added ubasic string variables user accessor API and unit testing.
