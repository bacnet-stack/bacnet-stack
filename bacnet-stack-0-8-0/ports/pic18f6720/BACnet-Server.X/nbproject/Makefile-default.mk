...
${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o: ../../../src/bacdevobjpropref.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) -DPRINT_ENABLED=0 -DBACDL_MSTP=1 -DBIG_ENDIAN=0 -DMAX_APDU=50 -DMAX_TSM_TRANSACTIONS=0 -I"../" -I"../../../include" -I"../../../demo/object" -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o   ../../../src/bacdevobjpropref.c 
...
${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o: ../../../src/bacdevobjpropref.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1386528437 
	@${RM} ${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DPRINT_ENABLED=0 -DBACDL_MSTP=1 -DBIG_ENDIAN=0 -DMAX_APDU=50 -DMAX_TSM_TRANSACTIONS=0 -I"../" -I"../../../include" -I"../../../demo/object" -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o   ../../../src/bacdevobjpropref.c 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1386528437/bacdevobjpropref.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
