...
/* Structure containing config and status info for a Audit Log */
    ...
    BACNET_STACK_EXPORT
    bool Audit_Log_Valid_Instance(
        uint32_t object_instance);
    BACNET_STACK_EXPORT
    unsigned Audit_Log_Count(
        void);
    BACNET_STACK_EXPORT
    uint32_t Audit_Log_Index_To_Instance(
        unsigned index);
    BACNET_STACK_EXPORT
    unsigned Audit_Log_Instance_To_Index(
        uint32_t instance);
    BACNET_STACK_EXPORT
    bool Audit_Log_Object_Instance_Add(
        uint32_t instance);
    ...
    BACNET_STACK_EXPORT
    int Audit_Log_Read_Property(
        BACNET_READ_PROPERTY_DATA * rpdata);

    BACNET_STACK_EXPORT
    bool Audit_Log_Write_Property(
    ...
    BACNET_STACK_EXPORT
    void AL_Insert_Notification_Rec(
        uint32_t instance,
        AL_NOTIFICATION *notif);
    ...
    BACNET_STACK_EXPORT
    bool AL_Out_Of_Service(
        uint32_t instance);

    BACNET_STACK_EXPORT
    void AL_Out_Of_Service_Set(
        uint32_t instance,
        bool b);

    BACNET_STACK_EXPORT
    bacnet_time_t AL_BAC_Time_To_Local(
        BACNET_DATE_TIME * SourceTime);

    BACNET_STACK_EXPORT
    void AL_Local_Time_To_BAC(
    ...
    BACNET_STACK_EXPORT
    int AL_encode_by_position(
        uint8_t * apdu,
        BACNET_READ_RANGE_DATA * pRequest);

    BACNET_STACK_EXPORT
    int AL_encode_by_sequence(
        uint8_t * apdu,
        BACNET_READ_RANGE_DATA * pRequest);

    BACNET_STACK_EXPORT
    int AL_encode_by_time(
        uint8_t * apdu,
        BACNET_READ_RANGE_DATA * pRequest);
