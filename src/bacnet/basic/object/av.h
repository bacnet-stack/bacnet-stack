...
extern "C" {
...
#if defined(INTRINSIC_REPORTING)
    BACNET_STACK_EXPORT
    uint32_t Analog_Value_Time_Delay(
            uint32_t object_instance);

    BACNET_STACK_EXPORT
    bool Analog_Value_Time_Delay_Set(
            uint32_t object_instance,
            uint32_t time_delay);

    BACNET_STACK_EXPORT
    uint32_t Analog_Value_Notification_Class(
            uint32_t object_instance);
    ...
    BACNET_STACK_EXPORT
    float Analog_Value_High_Limit(
            uint32_t object_instance);

    BACNET_STACK_EXPORT
    bool Analog_Value_High_Limit_Set(
            uint32_t object_instance,
            float high_limit);

    BACNET_STACK_EXPORT
    float Analog_Value_Low_Limit(
            uint32_t object_instance);

    BACNET_STACK_EXPORT
    bool Analog_Value_Low_Limit_Set(
            uint32_t object_instance,
            float low_limit);

    BACNET_STACK_EXPORT
    float Analog_Value_Deadband(
            uint32_t object_instance);

    BACNET_STACK_EXPORT
    bool Analog_Value_Deadband_Set(
            uint32_t object_instance,
            float deadband);

    BACNET_STACK_EXPORT
    BACNET_LIMIT_ENABLE Analog_Value_Limit_Enable(
            uint32_t object_instance);

    BACNET_STACK_EXPORT
    bool Analog_Value_Limit_Enable_Set(
            uint32_t object_instance,
            BACNET_LIMIT_ENABLE limit_enable);

    BACNET_STACK_EXPORT
    BACNET_EVENT_ENABLE Analog_Value_Event_Enable(
            uint32_t object_instance);
    ...
    BACNET_STACK_EXPORT
    BACNET_NOTIFY_TYPE Analog_Value_Notify_Type(
            uint32_t object_instance);
