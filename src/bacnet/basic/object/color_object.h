...
extern "C" {
    ...
    bool Color_Valid_Instance(
        uint32_t object_instance);
    unsigned Color_Count(
        void);
    uint32_t Color_Index_To_Instance(
        unsigned index);
    unsigned Color_Instance_To_Index(
        uint32_t object_instance);
    ...
    int Color_Read_Property(
        BACNET_READ_PROPERTY_DATA * rpdata);

    bool Color_Write_Property(
    ...
    bool Color_Tracking_Value_Set(
        ...
        BACNET_XY_COLOR * value,
        uint8_t priority);
    bool Color_Tracking_Value(
        uint32_t object_instance,
        BACNET_XY_COLOR * value);

    char *Color_Description(
        uint32_t instance);
    bool Color_Description_Set(
        uint32_t instance,
        char *new_name);

    bool Color_Write_Enabled(
        uint32_t instance);
    void Color_Write_Enable(
        uint32_t instance);
    void Color_Write_Disable(
        uint32_t instance);
