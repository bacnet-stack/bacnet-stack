...
bool bactext_application_tag_index(const char *search_name,
...
INDTEXT_DATA bacnet_property_names[] = {
    ...
    {PROP_NETWORK_ACCESS_SECURITY_POLICIES, "network-access-security-policies"},
...
const char *bactext_property_name_default(unsigned index,
...
const char *bactext_engineering_unit_name(unsigned index)
{
    return indtext_by_index_split_default(bacnet_engineering_unit_names, index,
                                          256, ASHRAE_Reserved_String,
                                          Vendor_Proprietary_String);
}

bool bactext_engineering_unit_index(const char *search_name,
                                    unsigned *found_index)
{
...
INDTEXT_DATA bacnet_day_of_week_names[] = {
    ...
    {5, "Friday"}, {6, "Saturday"}, {7, "Sunday"},    {255, "any day of week"},
    {0, NULL}};
...
bool bactext_event_transition_index(const char *search_name,
                                    unsigned *found_index)
{
...
bool bactext_binary_present_value_index(const char *search_name,
                                        unsigned *found_index)
{
...
INDTEXT_DATA bacnet_binary_polarity_names[] = {
    {POLARITY_NORMAL, "normal"}, {POLARITY_REVERSE, "reverse"}, {0, NULL}};
...
INDTEXT_DATA lighting_transition[] = {{BACNET_LIGHTING_TRANSITION_IDLE, "idle"},
