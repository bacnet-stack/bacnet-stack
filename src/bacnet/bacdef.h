...
#define MAX_BACNET_SERVICES_SUPPORTED 49                /* 2024-05-15 mods4bts This was duplicated elsewhere. BACNET_SERVICES_SUPPORTED_MAX (bacenum.h) cr3817423048721093412*/
#else
