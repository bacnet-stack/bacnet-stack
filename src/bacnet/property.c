...
static const int Device_Properties_Optional[] = { PROP_LOCATION,
    ...
    PROP_ACTIVE_COV_SUBSCRIPTIONS, PROP_SLAVE_PROXY_ENABLE,
    PROP_MANUAL_SLAVE_ADDRESS_BINDING, PROP_AUTO_SLAVE_DISCOVERY,
    PROP_SLAVE_ADDRESS_BINDING, PROP_LAST_RESTART_REASON,
    ...
    PROP_INTERVAL_OFFSET, PROP_PROFILE_NAME, -1 };
...
static const int Accumulator_Properties_Optional[] = { PROP_DESCRIPTION,
    ...
    PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
...
static const int Averaging_Properties_Required[] = { PROP_OBJECT_IDENTIFIER,
    ...
    PROP_MAXIMUM_VALUE, PROP_STATUS_FLAGS, PROP_EVENT_STATE,
    PROP_OUT_OF_SERVICE, PROP_UNITS, -1 };

static const int Averaging_Properties_Optional[] = { PROP_PROFILE_NAME,
    PROP_MINIMUM_VALUE_TIMESTAMP, PROP_VARIANCE_VALUE,
    PROP_MAXIMUM_VALUE_TIMESTAMP, PROP_DESCRIPTION, PROP_ATTEMPTED_SAMPLES,
    PROP_VALID_SAMPLES, PROP_OBJECT_PROPERTY_REFERENCE, PROP_WINDOW_INTERVAL,
...
static const int Binary_Value_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_RELIABILITY, PROP_INACTIVE_TEXT,
          PROP_ACTIVE_TEXT, PROP_CHANGE_OF_STATE_TIME,
          PROP_CHANGE_OF_STATE_COUNT, PROP_TIME_OF_STATE_COUNT_RESET,
          PROP_ELAPSED_ACTIVE_TIME, PROP_TIME_OF_ACTIVE_TIME_RESET,
          PROP_MINIMUM_OFF_TIME, PROP_MINIMUM_ON_TIME, PROP_PRIORITY_ARRAY,
...
static const int Channel_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_RELIABILITY, PROP_EXECUTION_DELAY,
          PROP_ALLOW_GROUP_DELAY_INHIBIT, PROP_EVENT_DETECTION_ENABLE,
...
static const int CharacterString_Value_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_EVENT_STATE, PROP_RELIABILITY,
          PROP_OUT_OF_SERVICE, PROP_PRIORITY_ARRAY, PROP_RELINQUISH_DEFAULT,
          PROP_TIME_DELAY, PROP_NOTIFICATION_CLASS, PROP_ALARM_VALUES,
...
static const int Lighting_Output_Properties_Required[]
    = { PROP_OBJECT_IDENTIFIER, PROP_OBJECT_NAME, PROP_OBJECT_TYPE,
          ...
          PROP_DEFAULT_FADE_TIME, PROP_DEFAULT_RAMP_RATE,
          PROP_DEFAULT_STEP_INCREMENT, PROP_PRIORITY_ARRAY,
          PROP_RELINQUISH_DEFAULT, PROP_LIGHTING_COMMAND_DEFAULT_PRIORITY, -1 };

static const int Lighting_Output_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_RELIABILITY, PROP_TRANSITION,
          PROP_FEEDBACK_VALUE, PROP_POWER, PROP_INSTANTANEOUS_POWER,
          PROP_MIN_ACTUAL_VALUE, PROP_MAX_ACTUAL_VALUE, PROP_COV_INCREMENT,
          PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
...
static const int Load_Control_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_STATE_DESCRIPTION, PROP_RELIABILITY,
          PROP_FULL_DUTY_BASELINE, PROP_NOTIFICATION_CLASS, PROP_TIME_DELAY,
          PROP_EVENT_ENABLE, PROP_ACKED_TRANSITIONS, PROP_NOTIFY_TYPE,
          PROP_EVENT_TIME_STAMPS, PROP_EVENT_MESSAGE_TEXTS,
          PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
...
static const int Life_Safety_Point_Properties_Optional[] = { PROP_DESCRIPTION,
    PROP_DEVICE_TYPE, PROP_NOTIFICATION_CLASS, PROP_LIFE_SAFETY_ALARM_VALUES,
    PROP_ALARM_VALUES, PROP_FAULT_VALUES, PROP_EVENT_ENABLE,
    PROP_ACKED_TRANSITIONS, PROP_NOTIFY_TYPE, PROP_EVENT_TIME_STAMPS,
    PROP_EVENT_MESSAGE_TEXTS, PROP_MAINTENANCE_REQUIRED, PROP_SETTING,
    PROP_DIRECT_READING, PROP_UNITS, PROP_MEMBER_OF,
    PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
...
static const int Multistate_Input_Properties_Optional[]
    = { PROP_DESCRIPTION, PROP_DEVICE_TYPE, PROP_RELIABILITY, PROP_STATE_TEXT,
          PROP_TIME_DELAY, PROP_NOTIFICATION_CLASS, PROP_ALARM_VALUES,
          PROP_FAULT_VALUES, PROP_EVENT_ENABLE, PROP_ACKED_TRANSITIONS,
          PROP_NOTIFY_TYPE, PROP_EVENT_TIME_STAMPS, PROP_EVENT_MESSAGE_TEXTS,
          PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
...
static const int Trend_Log_Properties_Required[]
    = { PROP_OBJECT_IDENTIFIER, PROP_OBJECT_NAME, PROP_OBJECT_TYPE, PROP_ENABLE,
          PROP_STOP_WHEN_FULL, PROP_BUFFER_SIZE, PROP_LOG_BUFFER,
          PROP_RECORD_COUNT, PROP_TOTAL_RECORD_COUNT, PROP_EVENT_STATE,
          PROP_LOGGING_TYPE, PROP_STATUS_FLAGS, -1 };
...
static const int Trend_Log_Properties_Optional[] = { PROP_DESCRIPTION,
    ...
    PROP_CLIENT_COV_INCREMENT, PROP_NOTIFICATION_THRESHOLD,
    PROP_RECORDS_SINCE_NOTIFICATION, PROP_LAST_NOTIFY_RECORD,
    PROP_NOTIFICATION_CLASS, PROP_EVENT_ENABLE, PROP_ACKED_TRANSITIONS,
    PROP_NOTIFY_TYPE, PROP_EVENT_TIME_STAMPS, PROP_EVENT_MESSAGE_TEXTS,
    PROP_ALIGN_INTERVALS, PROP_INTERVAL_OFFSET, PROP_TRIGGER, PROP_RELIABILITY,
    PROP_RELIABILITY_EVALUATION_INHIBIT, PROP_PROFILE_NAME, -1 };
