...
struct bacnet_handlers_data {
    ...
    char DEVICE_My_Object_Name[MAX_DEV_NAME_LEN + 1];   /* = "Supervisor"; */
    BACNET_DEVICE_STATUS DEVICE_System_Status;  /* = STATUS_OPERATIONAL; */
    uint16_t DEVICE_Vendor_Identifier;  /* = BACNET_VENDOR_ID; */
    char DEVICE_Model_Name[MAX_DEV_MOD_LEN + 1];        /* = "TOPKAPI"; */
    char DEVICE_Application_Software_Version[MAX_DEV_VER_LEN + 1];      /* = "5.0"; */
    char DEVICE_Location[MAX_DEV_LOC_LEN + 1];  /* = "FRA"; */
    char DEVICE_Description[MAX_DEV_DESC_LEN + 1];      /* = "Vision32-Server"; */
