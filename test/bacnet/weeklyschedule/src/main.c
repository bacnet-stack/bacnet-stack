...
static void test_BACnetWeeklySchedule()
{
    ...
    value.weeklySchedule[0].Time_Values[0].Value = (BACNET_SHORT_APPLICATION_DATA_VALUE) {
    ...
    value.weeklySchedule[0].Time_Values[1].Value = (BACNET_SHORT_APPLICATION_DATA_VALUE) {
        .tag = BACNET_APPLICATION_TAG_UNSIGNED_INT,
        .type.Unsigned_Int = 456,
    };

    value.weeklySchedule[6].TV_Count = 1;
    value.weeklySchedule[6].Time_Values[0].Value = (BACNET_SHORT_APPLICATION_DATA_VALUE) {
        .tag = BACNET_APPLICATION_TAG_UNSIGNED_INT,
