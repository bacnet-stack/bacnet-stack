...
static void testEventChangeOfCharacterstring(void)
{
    ...
    zassert_true(
        characterstring_same(
            data.notificationParams.changeOfCharacterstring.changedValue,
            data2.notificationParams.changeOfCharacterstring.changedValue),
        NULL);
    zassert_true(
        bitstring_same(
            &data.notificationParams.changeOfCharacterstring.statusFlags,
            &data2.notificationParams.changeOfCharacterstring.statusFlags),
        NULL);
    zassert_true(
        characterstring_same(
            data.notificationParams.changeOfCharacterstring.alarmValue,
            data2.notificationParams.changeOfCharacterstring.alarmValue),
        NULL);
}
...
static void testEventChangeOfStatusFlags(void)
{
    ...
    while (present_value[i].tag != MAX_BACNET_APPLICATION_TAG) {
        ...
        zassert_true(
            bitstring_same(
                &data.notificationParams.changeOfStatusFlags.referencedFlags,
                &data2.notificationParams.changeOfStatusFlags.referencedFlags),
            NULL);
        i++;
    }
}
...
static void testEventchangeOfReliability(void)
{
    ...
    zassert_equal(
        data.notificationParams.changeOfReliability.reliability,
        data2.notificationParams.changeOfReliability.reliability, NULL);
    zassert_true(
        bitstring_same(
            &data.notificationParams.changeOfReliability.statusFlags,
            &data2.notificationParams.changeOfReliability.statusFlags),
        NULL);
...
static void testEventChangeOfDiscreteValue(void)
{
    ...
    while (discrete_values[i].tag != MAX_BACNET_APPLICATION_TAG) {
        ...
        zassert_equal(
            data.notificationParams.changeOfDiscreteValue.newValue.tag,
            data2.notificationParams.changeOfDiscreteValue.newValue.tag, NULL);
        i++;
    }
    zassert_true(
        bitstring_same(
            &data.notificationParams.changeOfDiscreteValue.statusFlags,
            &data2.notificationParams.changeOfDiscreteValue.statusFlags),
        NULL);
}
...
static void testEventChangeOfTimer(void)
{
    ...
    zassert_equal(
        ...
        data2.notificationParams.changeOfTimer.newState, NULL);
    zassert_equal(
        data.notificationParams.changeOfTimer.initialTimeout,
        data2.notificationParams.changeOfTimer.initialTimeout, NULL);
    zassert_equal(
        data.notificationParams.changeOfTimer.lastStateChange,
        data2.notificationParams.changeOfTimer.lastStateChange, NULL);
    zassert_equal(
        datetime_compare(
            &data.notificationParams.changeOfTimer.expirationTime,
            &data2.notificationParams.changeOfTimer.expirationTime),
        0, NULL);
    zassert_equal(
        datetime_compare(
            &data.notificationParams.changeOfTimer.updateTime,
            &data2.notificationParams.changeOfTimer.updateTime),
        0, NULL);
    zassert_true(
        bitstring_same(
            &data.notificationParams.changeOfTimer.statusFlags,
            &data2.notificationParams.changeOfTimer.statusFlags),
        NULL);
}
