...
/* static void wait_for_direct_connection_established(node_ev_t *ev, BSC_NODE
*node, BACNET_SC_VMAC_ADDRESS *dest, char** urls, size_t urls_cnt)
{
    call_maintenance_timer(1, 0);
    while (1) {
        bsc_event_timedwait(ev->e, WAIT_EVENT_MS);
