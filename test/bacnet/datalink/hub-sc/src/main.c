    ...
    BVLC_SC_DECODED_MESSAGE *decoded_pdu)
{
    (void)decoded_pdu;
    debug_printf(
        "hub_connector_event() ev = %d, h = %p, user_arg = %p, pdu = "
        "%p, pdu_len = %d\n",
...
{
    debug_printf(
        "hub_function_event() ev = %d, h = %p, user_arg = %p\n", ev, h,
        user_arg);
...
static void test_hub_connector_url(bool primary)
{
    ...
    ret = bsc_hub_function_start(
        ...
        sizeof(server_key), BACNET_WEBSOCKET_SERVER_PORT, NULL, &hubf_uuid,
        &hubf_vmac, MAX_BVLC_LEN, MAX_NDPU_LEN,
...
static void test_hub_connector_reconnect(void)
{
    ...
    ret = bsc_hub_function_start(
        ca_cert, sizeof(ca_cert), server_cert, sizeof(server_cert), server_key,
        sizeof(server_key), BACNET_WEBSOCKET_SERVER_PORT2, NULL, &hubf_uuid2,
...
static void test_hub_function_bad_params(void)
{
    ...
    ret = bsc_hub_function_start(
        ca_cert, sizeof(ca_cert), server_cert, sizeof(server_cert), server_key,
        sizeof(server_key), BACNET_WEBSOCKET_SERVER_PORT + 1, NULL, &hubf_uuid2,
        &hubf_vmac2, MAX_BVLC_LEN, MAX_NDPU_LEN,
        BACNET_TIMEOUT, // connect timeout
        BACNET_TIMEOUT, // heartbeat timeout
        BACNET_TIMEOUT, // disconnect timeout
    ...
    ret = bsc_hub_function_start(
        ca_cert, sizeof(ca_cert), server_cert, sizeof(server_cert), server_key,
        sizeof(server_key), BACNET_WEBSOCKET_SERVER_PORT + 2, NULL, &hubf_uuid3,
